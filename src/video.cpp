...
SDL_Color mono_palette_colors[2] = {
    {0, 0, 0, 255},
    {255, 255, 255, 255}
};

struct SDL_Palette mono_palette = {
    2, mono_palette_colors, 0, 0
};

SDL_Color sixteen_palette_colors[16] = {
    {0x00, 0x00, 0x00, 0xff},
    {0x7f, 0x00, 0x00, 0xff},
    {0x00, 0x7f, 0x00, 0xff},
    {0x7f, 0x7f, 0x00, 0xff},
...
struct SDL_Palette sixteen_palette = {
    16, sixteen_palette_colors, 0, 0
};
